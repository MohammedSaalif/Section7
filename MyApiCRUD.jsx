...
const API_URL = "https://67d2583c90e0670699bd25bd.mockapi.io/users";
...
export default function MyAPICRUD() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setForm({ name: "", avatar: "", location: "" }); // Reset form
          ...
          <div key={user.id} style={{ padding: "10px", border: "1px solid #ccc", marginBottom: "10px", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
            ...
            <div>
              <button
                ...
                style={{ marginRight: "5px", padding: "5px 10px", backgroundColor: "green", color: "white", border: "none", cursor: "pointer" }}
              >
                Edit
              </button>
              <button
