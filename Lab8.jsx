...
const API_URL = 'https://67d25b7590e0670699d31f2.mockapi.io/users'; // Corrected API URL
      ...
      <table border="1">
        ...
        <tbody>
          {users.map((user) => (
            <tr key={user.id}>
            <td>
                {user.profileImageUrl ? (  // Changed to profileImageUrl
                  <img 
                    src={user.profileImageUrl}  // Display the image using profileImageUrl
                    alt="Profile" 
